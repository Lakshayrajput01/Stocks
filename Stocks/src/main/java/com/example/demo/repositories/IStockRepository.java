...
@Query(value = "select * from stock where stock_price > :price and stock_birth_time_stamp < :dateTime", nativeQuery = true)
List<Stock> getDataByAbovePriceAndLowerDate(Double price, LocalDateTime dateTime);
